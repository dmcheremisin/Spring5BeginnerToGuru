package info.cheremisin.recipeapp.bootstrap;

import info.cheremisin.recipeapp.domain.Category;
import info.cheremisin.recipeapp.domain.Difficulty;
import info.cheremisin.recipeapp.domain.Ingredient;
import info.cheremisin.recipeapp.domain.Notes;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setUrl("http://google.com");
        guacRecipe.setServings(1);
        guacRecipe.setSource("Book of Recipes");
